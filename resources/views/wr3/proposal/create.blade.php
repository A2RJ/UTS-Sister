                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('proposal.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea id="target_outcomes" name="target_outcomes" class="form-control">{{ old('target_outcomes') }}</textarea>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="date" id="contract_period" name="contract_period" class="form-control" value="{{ old('contract_period') }}">
                            @error('contract_period') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group mb-2">
                            <label for="funding_amount">Jumlah Pendanaan:</label>
                            <input type="number" id="funding_amount" name="funding_amount" class="form-control" value="{{ old('funding_amount') }}">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select id="application_status" name="application_status" class="form-control">
                                ...
                                <option value="{{ $status }}" {{ old('application_status') == $status ? 'selected' : '' }}>
                                    {{ $status }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div id="additionalFields" style="display: none">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="publication_title" name="publication_title" class="form-control" value="{{ old('publication_title') }}">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="author_status" class="form-control" id="author_status">
                                    ...
                                    <option value="{{ $status }}" {{ old('author_status') == $status ? 'selected' : '' }}>{{ $status }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="journal_name" name="journal_name" class="form-control" value="{{ old('journal_name') }}">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="volume_number" name="volume_number" class="form-control" value="{{ old('volume_number') }}">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="date" id="publication_date_year" name="publication_date_year" class="form-control" value="{{ old('publication_date_year') }}">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="journal_accreditation_status" class="form-control" id="journal_accreditation_status">
                                    ...
                                    <option value="{{ $status }}" {{ old('journal_accreditation_status') == $status ? 'selected' : '' }}>{{ $status }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="journal_publication_link" name="journal_publication_link" class="form-control" value="{{ old('journal_publication_link') }}">
