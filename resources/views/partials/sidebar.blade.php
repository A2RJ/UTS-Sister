         ...
         <ul class="nav">
             ...
             <li class="nav-item">
                 ...
                 <div class="collapse" id="uiComponents">
                     <ul class="nav sub-menu">
                         ...
                         <li class="nav-item">
                             <a href="../../pages/ui-components/list-group.html" class="nav-link">List
                                 group</a>
                         </li>
                         <li class="nav-item">
             ...
             <li class="nav-item">
                 ...
                 <div class="collapse" id="advancedUI">
                     <ul class="nav sub-menu">
                         ...
                         <li class="nav-item">
                             <a href="../../pages/advanced-ui/sweet-alert.html" class="nav-link">Sweet
                                 Alert</a>
                         </li>
                     </ul>
                 </div>
             ...
             <li class="nav-item">
                 ...
                 <div class="collapse" id="forms">
                     <ul class="nav sub-menu">
                         <li class="nav-item">
                             <a href="../../pages/forms/basic-elements.html" class="nav-link">Basic
                                 Elements</a>
                         </li>
                         <li class="nav-item">
