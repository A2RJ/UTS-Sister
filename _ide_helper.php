 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function sister()
        {
                        return \Illuminate\Http\Client\Factory::sister();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Client\Factory::referensi();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function dataPribadi()
        {
                        return \Illuminate\Http\Client\Factory::dataPribadi();
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function pool($item, $key)
        {
                        return \Illuminate\Routing\ResponseFactory::pool($item, $key);
        }
...
')
     ...
     */ 
        ...
        public static function dataPribadi()
        {
                        return \Illuminate\Http\Client\PendingRequest::dataPribadi();
        }
